...
const translations = {
  ...
  en: {
    ...
    heroTitle1: 'A FIRM DEDICATED',
    heroTitle2: 'TO THE CLIENT\'S PROJECT',
    heroDesc: 'We integrate into the project team as an extension of your engineering. We adopt your coding, manuals and delivery standards. We don\'t sell hours — we sell judgment: that of a strategic direction with ten years in the industry, and a commercial management with eighteen years building large mining accounts.',
    heroSubdesc: 'We operate under your internal processes, coding and deadlines. No middle layers, no account manager, no diluting the project among twenty parallel clients. The senior who signs is the same one on the phone.',
    viewProjects: 'View Projects',
    contactUs: 'Contact Us',
    about: 'About',
    aboutTitle: 'Technical consulting in architecture, engineering and project management for industry and mining',
    aboutSubtitle: 'Over 10 years of professional experience integrating architecture, engineering and project management as critical disciplines in mining and industrial projects.',
    ...
    aboutText2: 'We understand the language of engineering. Our work integrates fluidly with structural, electrical, mechanical, and PMO specialties, ensuring interference-free deliverables, compatible with the client\'s coding standards and optimized for the lifecycle of assets. We are a dedicated firm: the team that signs is the same that executes.',
    ...
    pillar4Desc: 'Access a dedicated team only when your project requires it. No permanent overhead and with the capacity to integrate into your internal processes, manuals and schedules.',
    ...
    servicesDesc: 'We offer comprehensive technical services in architecture, project management and multidisciplinary coordination, designed specifically for engineering projects, industrial facilities and mining operations.',
    servicesList: [
      ...
      'Dedicated Project Management for multidisciplinary projects'
    ],
  ...
  pt: {
    ...
    heroTitle1: 'UMA FIRMA DEDICADA',
    heroTitle2: 'AO PROJETO DO CLIENTE',
    heroDesc: 'Integramo-nos à equipe do projeto como uma extensão da sua engenharia. Adotamos sua codificação, manuais e padrões de entrega. Não vendemos horas — vendemos critério: o de uma direção estratégica com dez anos na indústria, e o de uma gestão comercial com dezoito anos construindo grandes contas de mineração.',
    heroSubdesc: 'Operamos sob seus processos internos, codificação e prazos. Sem camadas intermediárias, sem account manager, sem diluir o projeto entre vinte clientes paralelos. O sênior que assina é o mesmo que está ao telefone.',
    viewProjects: 'Ver Projetos',
    contactUs: 'Contate-nos',
    about: 'Sobre',
    aboutTitle: 'Consultoria técnica em arquitetura, engenharia e project management para indústria e mineração',
    aboutSubtitle: 'Mais de 10 anos de experiência profissional integrando arquitetura, engenharia e project management como disciplinas críticas em projetos de mineração e industriais.',
    ...
    aboutText2: 'Entendemos a linguagem da engenharia. Nosso trabalho se integra fluidamente com as especialidades estruturais, elétricas, mecânicas e PMO, garantindo entregáveis livres de interferências, compatíveis com a codificação do cliente e otimizados para o ciclo de vida dos ativos. Somos uma firma dedicada: a equipe que assina é a mesma que executa.',
    ...
    pillar4Desc: 'Acesse uma equipe dedicada apenas quando seu projeto necessitar. Sem overhead permanente e com capacidade de nos acoplarmos aos seus processos internos, manuais e prazos.',
    ...
    servicesDesc: 'Oferecemos serviços técnicos integrais em arquitetura, project management e coordenação multidisciplinar, projetados especificamente para projetos de engenharia, instalações industriais e operações de mineração.',
    servicesList: [
      ...
      'Project Management dedicado para projetos multidisciplinares'
    ],
  ...
  zh: {
    ...
    heroTitle1: '一家专注的事务所',
    heroTitle2: '专注于客户项目',
    heroDesc: '我们作为贵方工程的延伸融入项目团队。我们采用您的编码、手册和交付标准。我们不卖工时——我们卖判断力：源自十年行业经验的战略方向，以及十八年构建大型矿业客户的商务管理经验。',
    heroSubdesc: '我们遵循您的内部流程、编码和工期。没有中间层，没有客户经理，不会在二十个并行客户之间稀释项目。签字的高级专家就是接电话的人。',
    viewProjects: '查看项目',
    contactUs: '联系我们',
    about: '关于我们',
    aboutTitle: '为工业和矿业提供建筑、工程和项目管理的技术咨询',
    aboutSubtitle: '10多年的专业经验，将建筑、工程和项目管理作为矿业和工业项目中的关键学科进行整合。',
    aboutText1: '我们是一家专门从事大型采矿和工业基础设施开发的办公室。我们的不同之处在于，我们不仅将建筑视为审美目的，而且作为必须响应您流程的生产、安全和维护要求的关键运营组件。',
    aboutText2: '我们理解工程语言。我们的工作与结构、电气、机械和PMO专业流畅集成，确保交付成果无干扰、与客户编码标准兼容并针对资产生命周期进行优化。我们是一家专注的事务所：签字的团队就是执行的团队。',
    pillar1Title: '流程重点',
    ...
    pillar4Title: '灵活模式',
    pillar4Desc: '仅在您的项目需要时访问专属团队。无永久性开销，能够融入您的内部流程、手册和工期。',
    highlighted: '项目',
    ...
    services: '服务',
    servicesTitle: '服务',
    servicesDesc: '我们提供建筑、项目管理和多学科协调的综合技术服务，专为工程项目、工业设施和矿业运营而设计。',
    servicesList: [
      '工地和设施研究建筑总体规划',
      '关键空间的建设和改造，如办公室和更衣室',
      '控制室、服务器室、电气室和技术室',
