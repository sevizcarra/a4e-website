...
const translations = {
  es: {
    ...
    heroDesc: 'Somos una oficina técnica enfocada en desarrollo de los espacios físicos de sus procesos. Abordamos la arquitectura con rigor, entregando expedientes técnicos y soluciones constructivas que se alinean milimétricamente con los requerimientos de las áreas mecánicas, eléctricas y datos y todos los procesos que el proyecto requiera.',
    ...
    about: 'Nosotros',
    aboutTitle: 'Consultoría Técnica en Arquitectura para procesos de Ingeniería',
    aboutSubtitle: 'Más de 10 años integrando de manera eficiente la arquitectura como una especialidad crítica.',
    ...
    aboutText2: 'Entendemos el lenguaje de la ingeniería. Nuestro trabajo se integra fluidamente con las especialidades estructurales, eléctricas, mecánicas y PMO, garantizando proyectos libres de interferencias y optimizados para el cliclo de vida de los activos.',
    ...
    pillar3Desc: 'Utilizamos metodología BIM y herramientas de ingeniería para asegurar una integración perfecta con el resto de las disciplinas del proyecto.',
  ...
  en: {
    ...
    heroDesc: 'We are a technical office focused on developing the physical spaces for your processes. We approach architecture with rigor, delivering technical documents and construction solutions that align precisely with the requirements of mechanical, electrical, and data areas and all processes that the project requires.',
    ...
    about: 'About',
    aboutTitle: 'Technical Architectural Consulting for Engineering Processes',
    aboutSubtitle: 'Over 10 years efficiently integrating architecture as a critical specialty.',
    ...
    aboutText2: 'We understand the language of engineering. Our work integrates fluidly with structural, electrical, mechanical, and PMO specialties, ensuring interference-free projects optimized for the lifecycle of assets.',
    ...
    pillar3Desc: 'We use BIM methodology and engineering tools to ensure perfect integration with the rest of the project disciplines.',
    portfolio: 'Portfolio',
  ...
  pt: {
    ...
    heroDesc: 'Somos um escritório técnico focado no desenvolvimento dos espaços físicos de seus processos. Abordamos a arquitetura com rigor, entregando expedientes técnicos e soluções construtivas que se alinham milimétricamente com os requisitos das áreas mecânicas, elétricas e de dados e todos os processos que o projeto requeira.',
    ...
    about: 'Sobre',
    aboutTitle: 'Consultoria Técnica em Arquitetura para processos de Engenharia',
    aboutSubtitle: 'Mais de 10 anos integrando de maneira eficiente a arquitetura como uma especialidade crítica.',
    ...
    aboutText2: 'Entendemos a linguagem da engenharia. Nosso trabalho se integra fluidamente com as especialidades estruturais, elétricas, mecânicas e PMO, garantindo projetos livres de interferências e otimizados para o ciclo de vida dos ativos.',
    ...
    pillar3Desc: 'Utilizamos metodologia BIM e ferramentas de engenharia para assegurar uma integração perfeita com o resto das disciplinas do projeto.',
    portfolio: 'Portfólio',
