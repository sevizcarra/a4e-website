...
const translations = {
  es: {
    ...
    tagline: 'Soluciones Técnicas como Soporte para sus Operaciones',
    heroTitle1: 'ESPECIALISTAS EN ARQUITECTURA',
    heroTitle2: 'PARA PROYECTOS DE INGENIERÍA',
    heroDesc: 'Somos una oficina técnica enfocada en la componente física de sus procesos. Abordamos la arquitectura con rigor e ingeniería, entregando expedientes técnicos y soluciones constructivas que se alinean milimétricamente con los requerimientos mecánicos, eléctricos y de procesos del proyecto general.',
    heroSubdesc: 'No solo diseñamos edificios; ejecutamos la arquitectura y la ingeniería de detalle necesaria para que sus activos industriales funcionen en el más alto estándar.',
    viewProjects: 'Ver Proyectos',
    contactUs: 'Contáctenos',
    about: 'Nosotros',
    aboutTitle: 'Consultoría Técnica en Arquitectura Industrial',
    aboutSubtitle: 'Más de 10 años integrando la arquitectura como una especialidad crítica dentro de la ingeniería de procesos.',
    aboutText1: 'Somos una oficina especializada en el desarrollo de infraestructura para la gran minería e industria. Nos diferenciamos por abordar la arquitectura no como un fin estético, sino como un componente operacional que debe responder a las exigencias de producción, seguridad y mantenimiento de la planta.',
    aboutText2: 'Entendemos el lenguaje de la ingeniería. Nuestro trabajo se integra fluidamente con las especialidades mecánicas, eléctricas y estructurales, garantizando proyectos libres de interferencias y optimizados para el ciclo de vida del activo.',
    ...
    pillar2Desc: 'Dominio avanzado de normativas industriales y estándares de seguridad minera. Entregamos expedientes listos para aprobación y construcción.',
    pillar3Title: 'Coordinación Multidisciplinaria',
    pillar3Desc: 'Utilizamos metodología BIM y herramientas de ingeniería para asegurar una integración perfecta con el resto de las disciplinas del proyecto (EPC/EPCM).',
    ...
    servicesList: [
      'Diseño de Salas de Control y Centros de Operaciones',
      'Arquitectura de Instalaciones Industriales',
...
const Footer = ({ t }) => {
  ...
  return (
    <footer ref={ref} className="relative bg-neutral-900 py-12 border-t border-white/5 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-neutral-950 to-neutral-900" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className={`flex flex-col md:flex-row justify-between items-center gap-8 transition-all duration-700 ${
          ...
          <div className={`hidden md:block flex-1 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent mx-8 transition-all duration-700 delay-200 ${
